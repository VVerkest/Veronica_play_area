...
//__________________________________
void analysis::fill_histos(PHCompositeNode *topNode)
{
...
void analysis::fill_truth_ntuple(PHCompositeNode *topNode)
{
...
//_____________________________________
void analysis::fill_sf_ntuple(PHCompositeNode *topNode)
{
...
//___________________________________
void analysis::GetNodes(PHCompositeNode *topNode)
{
 //DST objects
 //Truth container
